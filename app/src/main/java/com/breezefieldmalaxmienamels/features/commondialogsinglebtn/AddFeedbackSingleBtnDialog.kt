package com.breezefieldmalaxmienamels.features.commondialogsinglebtn
...
import com.breezefieldmalaxmienamels.app.domain.ShopVisitCompetetorModelEntity
import com.breezefieldmalaxmienamels.app.domain.VisitRemarksEntity
...
import com.breezefieldmalaxmienamels.features.addshop.presentation.ProspectListDialog
import com.breezefieldmalaxmienamels.features.dashboard.presentation.DashboardActivity
import com.breezefieldmalaxmienamels.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezefieldmalaxmienamels.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezefieldmalaxmienamels/files", "recorded_audio${System.currentTimeMillis()}.mp3")
