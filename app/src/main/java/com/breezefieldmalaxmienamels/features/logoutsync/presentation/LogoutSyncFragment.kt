package com.breezefieldmalaxmienamels.features.logoutsync.presentation
...
import com.breezefieldmalaxmienamels.app.AppDatabase
...
import com.breezefieldmalaxmienamels.app.utils.Toaster
...
import com.breezefieldmalaxmienamels.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldmalaxmienamels.features.billing.api.AddBillingRepoProvider
import com.breezefieldmalaxmienamels.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldmalaxmienamels.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldmalaxmienamels.features.document.model.AddEditDocumentInputParams
import com.breezefieldmalaxmienamels.features.document.model.DocumentAttachmentModel
...
import com.breezefieldmalaxmienamels.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezefieldmalaxmienamels.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldmalaxmienamels.features.orderhistory.model.*
...
import com.breezefieldmalaxmienamels.features.quotation.model.AddQuotInputModel
import com.breezefieldmalaxmienamels.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldmalaxmienamels.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldmalaxmienamels.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefieldmalaxmienamels.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefieldmalaxmienamels.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezefieldmalaxmienamels.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldmalaxmienamels.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldmalaxmienamels.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldmalaxmienamels.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldmalaxmienamels.mappackage.SendBrod
import com.breezefieldmalaxmienamels.widgets.AppCustomTextView
import com.breezefieldmalaxmienamels.MonitorService
import com.breezefieldmalaxmienamels.MySingleton
import com.breezefieldmalaxmienamels.app.AlarmReceiver
...
import com.breezefieldmalaxmienamels.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefieldmalaxmienamels.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefieldmalaxmienamels.features.login.model.GetConcurrentUserResponse
...
import com.breezefieldmalaxmienamels.features.orderITC.SyncDeleteOpptL
...
import com.breezefieldmalaxmienamels.features.orderITC.SyncOpptProductL
import com.breezefieldmalaxmienamels.features.orderITC.SyncOrd
import com.breezefieldmalaxmienamels.features.orderITC.SyncOrdProductL
import com.breezefieldmalaxmienamels.features.performance.model.Gps_status_list
import com.breezefieldmalaxmienamels.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldmalaxmienamels.features.returnsOrder.ReturnProductList
import com.breezefieldmalaxmienamels.features.returnsOrder.ReturnRequest
import com.breezefieldmalaxmienamels.features.viewAllOrder.model.NewOrderSaveApiModel
import com.breezefieldmalaxmienamels.features.viewAllOrder.model.NewStockSync
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezefieldmalaxmienamels/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldmalaxmienamelslogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldmalaxmienamelslogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldmalaxmienamelslogsample/log.zip").path);
