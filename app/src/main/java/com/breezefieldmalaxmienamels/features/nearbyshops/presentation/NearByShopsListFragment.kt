...
import com.breezefieldmalaxmienamels.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezefieldmalaxmienamels.app.utils.FTStorageUtils
import com.breezefieldmalaxmienamels.app.utils.NotificationUtils
...
import com.breezefieldmalaxmienamels.features.addshop.model.AssignedToShopListResponseModel
import com.breezefieldmalaxmienamels.features.addshop.model.QuestionSubmit
import com.breezefieldmalaxmienamels.features.addshop.model.UpdateAddrReq
import com.breezefieldmalaxmienamels.features.addshop.model.UpdateAddressShop
...
import com.breezefieldmalaxmienamels.features.addshop.presentation.*
...
import com.breezefieldmalaxmienamels.features.location.model.ShopDurationRequestData
...
import com.breezefieldmalaxmienamels.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
import com.breezefieldmalaxmienamels.features.marketing.model.MarketingCategoryListResponse
...
import com.breezefieldmalaxmienamels.features.nearbyshops.model.StageListResponseModel
...
import com.breezefieldmalaxmienamels.features.shopdetail.presentation.AddCollectionDialog
...
import com.breezefieldmalaxmienamels.features.viewAllOrder.interf.QaOnCLick
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezefieldmalaxmienamelsApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
